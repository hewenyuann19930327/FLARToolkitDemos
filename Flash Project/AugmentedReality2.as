package {
	...
	public class AugmentedReality extends Sprite
	{
		...
		private var flarSingleMarkerDetector2	: FLARSingleMarkerDetector;
		...
		**/
		public function AugmentedReality ()
		{
			...
			ce=new CardEmulator("assets/models/tower/images/marker00.jpg",VIDEO_WIDTH,VIDEO_HEIGHT,true)
			addChild(ce)
		...
		**/		
		private function preparePaperVision3D () : void
		{
			...
			collada3DModel2.scaleX = collada3DModel2.scaleY = collada3DModel2.scaleZ = 1;
			//collada3DModel.z = 5;			//Moves Model 'Up' a Line Perpendicular to Marker
			...
			collada3DModel2.rotationZ = 45;	//Rotates Model Around a Line Perpendicular to Marker
		...
		**/
		private function loopToDetectMarkerAndUpdate3D (aEvent : Event) : void
		{
			...
			} catch (error : Error) {trace(error.message+"364545645")}
		}
	}
}
